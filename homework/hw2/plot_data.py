...
def read_data(file_path='./data_files/que_1.txt', question_idx=1):
    ...
    while i <= (len(lines) - group_size):
        ...
        # Extract Y_values
        Y1_values.append(float(line_content[7]) * 180 / np.pi)    # joint 1
        Y2_values.append(float(line_content[7]) * 180 / np.pi)    # joint 3
        Y3_values.append(float(line_content[7]) * 180 / np.pi)    # joint 4
...
def plot_data(q_values, Y1_values, Y2_values, Y3_values, subTitle_values, title_values, output_file_path='que_1.png'):
    ...
    Y_label_list = ['joint_7 angle', 'joint_7 angle', 'joint_7 angle']
    # Y_unit = 'radians'
    Y_unit = 'degrees'
